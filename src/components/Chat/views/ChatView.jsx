...
const ChatView = (props) => {
    ...
    const getLastElementInChat = () => {
        ...
        const lastElementInChat = element.children[element.children.length - 1];
    ...
    const scrollChatToBottom = () => {
        ...
        if (!chat.messages) chatContainerRef.current?.scrollTo(0, 0);
        
        // if messages; scroll to bottom
        else getLastElementInChat()
            ?.scrollIntoView({ behavior: 'smooth' });

        const totalY = chatContainerRef.current?.scrollHeight;
